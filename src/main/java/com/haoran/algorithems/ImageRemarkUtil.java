...
public class ImageRemarkUtil {
    ...
    public static void markImageByText(String logoText, String srcImgPath,
        ...
        try {
            ...
            Rectangle2D rc = fm.getStringBounds(logoText, g);
            Double wordWidth = rc.getWidth() * Math.cos(Math.toRadians(degree)) ;
            Double wordHeight =rc.getWidth() * Math.sin(Math.toRadians(degree))/2;
            g.drawString(logoText, buffImg.getWidth()/2 - wordWidth.intValue()  , buffImg.getHeight() / 2 - wordHeight.intValue());
            // 9、释放资源
            g.dispose();
            // 10、生成图片
            os = new FileOutputStream(targerPath);
    ...
    public static void main(String[] args) {
        String srcImgPath = "C:\\Users\\haoran\\Desktop\\mmexport1597046016116.jpg";
        String logoText = "复 印 无 效";
        String iconPath = "C:\\Users\\haoran\\Desktop\\logo.png";

        String targerTextPath = "C:\\Users\\haoran\\Desktop\\test.jpg";
        String targerTextPath2 = "C:\\Users\\haoran\\Desktop\\qie_text_rotate2.jpg";

        String targerIconPath = "C:\\Users\\haoran\\Desktop\\icon.jpg";
        String targerIconPath2 = "C:\\Users\\haoran\\Desktop\\qie_icon_rotate.jpg";
